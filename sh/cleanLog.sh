...
sed -i ‘1,50’ /var/log//var/log/mysqld.log #清除数据库日志
...
sed -i ‘1,50d’ /var/log/nginx/access.log #清除nginx日志
sed -i ‘1,50d’ /var/log/nginx/error.log
sed -i ‘1,50d’ /var/log/zabbix/zabbix_server.log
sed -i ‘1,50d’ /var/log/zabbix/zabbix_agent.log
history -c #清除历史执行命令
...
rm -fr /var/log/httpd/access_log-* /var/log/httpd/error_log-* /var/log/httpd/ssl_access_log-* /var/log/httpd/ssl_error_log-* /var/log/httpd/ssl_request_log-*  /var/log/nginx/error.log-* /var/log/nginx/access.log-* /var/log/zabbix/zabbix_server.log-* /var/log/zabbix/zabbix_agent.log-*
