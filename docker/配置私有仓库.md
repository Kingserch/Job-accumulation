        ...
        "events": [
            {
                ...
                "action": "push",	#事件关联的动作类型push/pull
                "target": {
                    "mediaType":  "application/vnd.docker.distribution.manifest.v1+	#事件payload类型
                        json",
                    "size": 45765,
                    "digest":  "sha256:fd0af29ba2ae034449bffb18dd6db2ed90d798464cc43a
                        a81e63770713edaea8",
                    "length": 45765,
                    "repository":“test-user/hello-world”,	#镜像名称
                    "url": "http://registry-server/v2/test-user/hello-world/manifests/	#事件对应的地址
                ...
                "request": {
                    ...
                    "method": "PUT",	#httpd请求的方法put/post
					          "useragent": "docker/1.9.1 go/go1.4.2 git-commit/a34a1d5 kernel/	#带来此事件的客户端类型
                        4.2.0-35-generic os/linux arch/amd64"
                },
                "actor": {
                    "name":“test-user"		#发起此动作的用户
                },
                "source": {
