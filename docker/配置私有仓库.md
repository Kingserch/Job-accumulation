...
```
docker pull nginx
docker run -d -p 89:80 nginx
51347ce50f0a19b1a2b4f409329759210ba971a88a4394df48f2fc08f82ab6e8
[root@m129 nginx]# curl -I http://localhost:89
HTTP/1.1 200 OK
Server: nginx/1.17.6
Date: Wed, 08 Jan 2020 04:49:45 GMT
